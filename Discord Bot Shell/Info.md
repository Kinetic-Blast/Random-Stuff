...
Prefix Bash commands with "$" to execute them through the bot.
The bot will respond with the output of the command, formatted within triple backticks ("```") for readability.
